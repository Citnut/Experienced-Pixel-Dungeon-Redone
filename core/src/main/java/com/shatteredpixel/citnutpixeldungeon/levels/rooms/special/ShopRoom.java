...
import com.shatteredpixel.citnutpixeldungeon.items.*;
...
import com.shatteredpixel.citnutpixeldungeon.items.bags.*;
import com.shatteredpixel.citnutpixeldungeon.items.bombs.Bomb;
import com.shatteredpixel.citnutpixeldungeon.items.fishingrods.*;
...
public class ShopRoom extends SpecialRoom {
	...
	protected static ArrayList<Item> generateItems() {
		...
		case 6: default:
			...
			itemsToSpawn.add(new GoldenFishingRod());
		...
		case 11:
			...
			itemsToSpawn.add(new NeutroniumFishingRod());
			itemsToSpawn.add(new AvaritiaFishingRod());
			break;
			
		case 16:
			w = Generator.random(Generator.wepTiers[4]);
			if(Math.random()>0.5){
				itemsToSpawn.add(Generator.random(Generator.wepTiers[5]));
			}
			...
			itemsToSpawn.add( new AlchemyBag());
			itemsToSpawn.add(new ChaosFishingRod());
//			itemsToSpawn.add(new SpiritualFishingRod());
			itemsToSpawn.add( new VipArmor().identify());
			break;

		case 20: case 21:
			w = Generator.random(Generator.wepTiers[5]);
