...
package com.shatteredpixel.citnutpixeldungeon.sprites;
...
public class ItemSpriteSheet {
	...
	private static final int MOD_ARMOR = xy(1, 33);
	public static final int VIPARMOR = MOD_ARMOR+0;

	static {
		assignItemRect(VIPARMOR, 12, 12);
	}

	private static final int MOD_WEP = xy(1, 34);
	public static final int STAFFOFHOMA = MOD_WEP+0;

	static{
		assignItemRect(STAFFOFHOMA, 16, 16);
	}
