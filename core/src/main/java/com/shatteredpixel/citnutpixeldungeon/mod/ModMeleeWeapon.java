...
public class ModMeleeWeapon extends MeleeWeapon implements ModSpriteItem {
	...
	public ModMeleeWeapon() {
		super();
	}

	public ModMeleeWeapon(ModItemDef def) {
		applyDef(def);
	}
	...
	public String name() {
		ModItemDef d = def();
		return d != null ? d.name : "Missing Mod Weapon";
	}
