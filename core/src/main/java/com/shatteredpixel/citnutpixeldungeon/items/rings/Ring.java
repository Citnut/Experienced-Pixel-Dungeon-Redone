...
import com.shatteredpixel.citnutpixeldungeon.actors.buffs.EnhancedRings;
...
public class Ring extends KindofMisc {
	...
	public long combinedBonus(Hero hero){
		...
		if (hero.belongings.secondring() != null && hero.belongings.secondring().getClass() == getClass()){
			bonus += hero.belongings.secondring().soloBonus();
		}
	...
	public long combinedBuffedBonus(Hero hero){
		...
		if (hero.belongings.secondring() != null && hero.belongings.secondring().getClass() == getClass()){
			bonus += hero.belongings.secondring().soloBuffedBonus();
		}
		if (hero.belongings.misc() != null && hero.belongings.misc().getClass() == getClass()){
