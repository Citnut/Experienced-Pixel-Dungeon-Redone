...
import com.shatteredpixel.citnutpixeldungeon.items.armor.*;
import com.shatteredpixel.citnutpixeldungeon.items.artifacts.AlchemistsToolkit;
import com.shatteredpixel.citnutpixeldungeon.items.artifacts.Artifact;
import com.shatteredpixel.citnutpixeldungeon.items.artifacts.ChaliceOfBlood;
import com.shatteredpixel.citnutpixeldungeon.items.artifacts.CloakOfShadows;
import com.shatteredpixel.citnutpixeldungeon.items.artifacts.DriedRose;
import com.shatteredpixel.citnutpixeldungeon.items.artifacts.EtherealChains;
import com.shatteredpixel.citnutpixeldungeon.items.artifacts.HornOfPlenty;
import com.shatteredpixel.citnutpixeldungeon.items.artifacts.MasterThievesArmband;
import com.shatteredpixel.citnutpixeldungeon.items.artifacts.SandalsOfNature;
import com.shatteredpixel.citnutpixeldungeon.items.artifacts.TalismanOfForesight;
import com.shatteredpixel.citnutpixeldungeon.items.artifacts.TimekeepersHourglass;
import com.shatteredpixel.citnutpixeldungeon.items.artifacts.UnstableSpellbook;
...
import com.shatteredpixel.citnutpixeldungeon.items.rings.RingOfAccuracy;
import com.shatteredpixel.citnutpixeldungeon.items.rings.RingOfArcana;
import com.shatteredpixel.citnutpixeldungeon.items.rings.RingOfElements;
import com.shatteredpixel.citnutpixeldungeon.items.rings.RingOfEnergy;
import com.shatteredpixel.citnutpixeldungeon.items.rings.RingOfEvasion;
import com.shatteredpixel.citnutpixeldungeon.items.rings.RingOfForce;
import com.shatteredpixel.citnutpixeldungeon.items.rings.RingOfFuror;
import com.shatteredpixel.citnutpixeldungeon.items.rings.RingOfHaste;
import com.shatteredpixel.citnutpixeldungeon.items.rings.RingOfMight;
import com.shatteredpixel.citnutpixeldungeon.items.rings.RingOfSharpshooting;
import com.shatteredpixel.citnutpixeldungeon.items.rings.RingOfTenacity;
import com.shatteredpixel.citnutpixeldungeon.items.scrolls.Scroll;
import com.shatteredpixel.citnutpixeldungeon.items.scrolls.ScrollOfIdentify;
import com.shatteredpixel.citnutpixeldungeon.items.scrolls.ScrollOfLullaby;
import com.shatteredpixel.citnutpixeldungeon.items.scrolls.ScrollOfMagicMapping;
import com.shatteredpixel.citnutpixeldungeon.items.scrolls.ScrollOfMirrorImage;
import com.shatteredpixel.citnutpixeldungeon.items.scrolls.ScrollOfRage;
...
import com.shatteredpixel.citnutpixeldungeon.items.scrolls.ScrollOfTerror;
...
import com.shatteredpixel.citnutpixeldungeon.items.stones.StoneOfAggression;
import com.shatteredpixel.citnutpixeldungeon.items.stones.StoneOfAugmentation;
import com.shatteredpixel.citnutpixeldungeon.items.stones.StoneOfBlast;
import com.shatteredpixel.citnutpixeldungeon.items.stones.StoneOfBlink;
import com.shatteredpixel.citnutpixeldungeon.items.stones.StoneOfClairvoyance;
import com.shatteredpixel.citnutpixeldungeon.items.stones.StoneOfDeepSleep;
import com.shatteredpixel.citnutpixeldungeon.items.stones.StoneOfDisarming;
import com.shatteredpixel.citnutpixeldungeon.items.stones.StoneOfEnchantment;
import com.shatteredpixel.citnutpixeldungeon.items.stones.StoneOfFear;
import com.shatteredpixel.citnutpixeldungeon.items.stones.StoneOfFlock;
import com.shatteredpixel.citnutpixeldungeon.items.stones.StoneOfIntuition;
import com.shatteredpixel.citnutpixeldungeon.items.stones.StoneOfShock;
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.ChaoticCenser;
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.DimensionalSundial;
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.ExoticCrystals;
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.EyeOfNewt;
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.MimicTooth;
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.MossyClump;
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.ParchmentScrap;
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.PetrifiedSeed;
...
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.ShardOfOblivion;
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.ThirteenLeafClover;
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.TrapMechanism;
...
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.VialOfBlood;
import com.shatteredpixel.citnutpixeldungeon.items.trinkets.WondrousResin;
...
import com.shatteredpixel.citnutpixeldungeon.items.wands.WandOfCorrosion;
import com.shatteredpixel.citnutpixeldungeon.items.wands.WandOfCorruption;
...
import com.shatteredpixel.citnutpixeldungeon.items.weapon.melee.*;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.Bolas;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.FishingSpear;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.ForceCube;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.HeavyBoomerang;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.Javelin;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.Kunai;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.MissileWeapon;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.Shuriken;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.ThrowingClub;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.ThrowingHammer;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.ThrowingKnife;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.ThrowingSpear;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.ThrowingSpike;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.ThrowingStone;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.Tomahawk;
import com.shatteredpixel.citnutpixeldungeon.items.weapon.missiles.Trident;
