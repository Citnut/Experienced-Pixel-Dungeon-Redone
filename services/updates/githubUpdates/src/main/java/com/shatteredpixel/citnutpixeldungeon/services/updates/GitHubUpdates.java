...
package com.shatteredpixel.citnutpixeldungeon.services.updates;
...
public class GitHubUpdates extends UpdateService {
	...
	public void checkForUpdate(boolean useMetered, boolean includeBetas, UpdateResultCallback callback) {
		...
		httpGet.setUrl("https://api.github.com/repos/Citnut/Experienced-Pixel-Dungeon-Redone/releases");
